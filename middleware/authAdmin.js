...
module.exports = (req, res, next) => {
  try {
    ...
    res
      .status(401)
      .json("Administrateur non reconnu, veuillez vous reconnecter");
  }
};
